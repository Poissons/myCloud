...
if __name__ == '__main__':
    ...
    # p7 = multiprocessing.Process(target=resources_on_each_node)
    # p2.start()
    # p4.start()
    # p5.start()
    # p6.start()
    # p7.start()
    p1.start()
    # manager=Manager().__enter__()
    # managerState=manager.dict()
    # mdata=managerState
    # p3 = multiprocessing.Process(target=collect_data,args=(managerState,))
    # p3.start()
