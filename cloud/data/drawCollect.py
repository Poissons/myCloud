...
if __name__ == "__main__":
    ...
    data = pd.read_csv(r'./offload/poisson/10_15_165_offload/random/collect_computeha.csv', usecols=[3, 4, 5])
    ...
    plt.ylim(0, 1)
    plt.savefig('./offload/poisson/10_15_165_offload/random/collectha.png')
